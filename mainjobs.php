   ...
   <table style="width:100%;"> 
        ...
        <thead>
            <tr>
				...
				<th style="width:10%;"><h4>Job Location</h4></th>
				<th style="width:10%;"><h4>Job Post</h4></th>
                    ...
                    while($row = $result->fetch_assoc()) 
					{
						$jid=$row['jid'];
                         ...
                         echo "<tr><td><form action='' method='post'>".$row['jid']."<td>".$row['cname']."<td>".$row['jdesc']."<td>".$row['loc']."<td>".$row['jpost']."<td>".$row['sal']."</td><td>".
                            "<button type='submit' class='btn btn-xs btn-success' name='_view' id='_view' onclick=apply('".$jid."')>Apply</button></form> <br> <br>".
